...
file_path = "/autofs/cluster/fusion/gbm6/Projects/cbm/dense/"
src_cort = mne.read_source_spaces(file_path + "src_cort-src.fif")
src_whole = mne.read_source_spaces(file_path + "src_whole-src.fif")
...
fwd = mne.read_forward_solution(file_path + "my_forward-fwd.fif")
...
inverse_operator = mne.minimum_norm.read_inverse_operator(file_path + "my_inverse-inv.fif")
